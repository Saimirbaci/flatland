...
description: Scaffold a new Flatland model or world plugin end-to-end (header, impl, pluginlib export, XML manifest, CMake, tests). Invoke when adding a sensor, drive, or world behavior — the most common change in this repo (recent: imu, gps, diff-drive tf).
---
